...
class ListPurchaseComposeFragment : BaseFragment() {

    private val viewModel: ListPurchaseComposeViewModel by viewModels { viewModelFactory }
    ...
    @Composable
    fun ToolBar(
        viewModel: ListPurchaseComposeViewModel = viewModel()
    ) {
        SearchTopAppBar(
        ...
        LazyColumn(
            ...
            itemsIndexed(
                ...
                if (dismissState.isDismissed(DismissDirection.EndToStart) ||
                    ...
                    LaunchedEffect(key1 = this@ListPurchaseComposeFragment, block = {
